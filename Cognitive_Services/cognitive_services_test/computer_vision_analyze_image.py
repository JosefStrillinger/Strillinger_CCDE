...
image_analysis = client.analyze_image_in_stream((open('cognitive_services_test/img/ibk.jpg', 'rb')),visual_features=[VisualFeatureTypes.tags])

for tag in image_analysis.tags:
    print(tag)

analysis = client.describe_image(url, 3, "en")  #max_descriptions=3, language
analysis = client.describe_image_in_stream(open('cognitive_services_test/img/ibk.jpg', 'rb'), 3, "en")
